"""
Django settings for clglibproject project.
...
SECRET_KEY = 'django-insecure-ak5eoe_qhcc-z2=f9ft(ebl4w=_ucf(#lmn7h*5m@ma0@rv@a8'
...
ROOT_URLCONF = 'clglibproject.urls'
...
WSGI_APPLICATION = 'clglibproject.wsgi.application'
